         ...
         arrSetUnique.map(item => 
            `
                <div>
                    ...
                    <p class="text-muted">Số lượng: ${getCountItem(carts, item.maSP, item.price)}</p>
                    <h5 class="text-muted">${convertMoney(item.price*getCountItem(carts, item.maSP, item.price))}</h5>
                </div>
            `).join('')
